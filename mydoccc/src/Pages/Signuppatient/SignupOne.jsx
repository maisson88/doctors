                    ...
                    <form action="#!">
                      <div class="row gy-3 gy-md-4 overflow-hidden">
                        ...
                        <div class="col-12">
                          ...
                          <input type="text" class="form-control" id="lastName" placeholder="Last Name" required name="name"  value={formData.name} onChange={handleInputChange} />
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-12">
                          ...
                          <input type="password" class="form-control"   required name="confirmpassword"  value={formData.confirmpassword} onChange={handleInputChange} />
                        </div>
                        <div class="col-12">
