     ...
     <section class="p-3 p-md-4 p-xl-5">
          <div class="container">
            <div class="card border-light-subtle shadow-sm">
              <div class="row g-0">
                <div class="col-12 col-md-6  text-light" style={{backgroundColor:'#3E8989'}} >
                  <div class="d-flex align-items-center justify-content-center h-100">
                    ...
                    <img class="img-fluid rounded " loading="lazy" src={`http://res.cloudinary.com/dvfyd13tg/image/upload/v1710516155/zqtf26p9xdlad2rrhfep.png`} width="100" height="80" alt="DOKTORZ Logo"/>
                      ...
                      <hr class=" mb-4"/>
                      <h2 class="h1 mb-4">We make digital product that drive you to stand out.</h2>
                      <p class="lead m-0">you will be able to choose among the most skilled doctors in different specialties.</p>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="row">
                      <div class="col-12">
                        <div class="mb-5">
                          ...
                          <h3 class="fs-6 fw-normal text-secondary m-0">If you are a doctor <Link to={'/form/doctor'} class="link-primary text-decoration-none">click here</Link></h3>
                        </div>
                      </div>
                    </div>
                    <form action="#!">
...
{/* <div>
    ...
    <div class="d-flex justify-content-center">
        <div class="btn  btn-rounded bg-primary" >
            <label class="form-label text-white m-1"  onClick={handelFileInputChang}>Upload Profile photo</label>
            <input  class="form-control " type="file" name="photo" id="customFile" accept=".jpg, .png" onChange={handelFileInputChang} required />
        </div>
    </div>
</div> */}
                        ...
                        <div class="d-flex gap-3 flex-column flex-xl-row">
                          <a href="#!" class="btn bsb-btn-xl btn-outline-primary">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-google" viewBox="0 0 16 16">
                              <path style={{color:'#3E8989'}} d="M15.545 6.558a9.42 9.42 0 0 1 .139 1.626c0 2.434-.87 4.492-2.384 5.885h.002C11.978 15.292 10.158 16 8 16A8 8 0 1 1 8 0a7.689 7.689 0 0 1 5.352 2.082l-2.284 2.284A4.347 4.347 0 0 0 8 3.166c-2.087 0-3.86 1.408-4.492 3.304a4.792 4.792 0 0 0 0 3.063h.003c.635 1.893 2.405 3.301 4.492 3.301 1.078 0 2.004-.276 2.722-.764h-.003a3.702 3.702 0 0 0 1.599-2.431H8v-3.08h7.545z" />
                            </svg>
                            <span style={{color:'#3E8989'}} class="ms-2 fs-6">Google</span>
                          </a>
                          <a href="#!" class="btn bsb-btn-xl btn-outline-primary">
