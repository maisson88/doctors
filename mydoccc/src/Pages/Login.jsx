...
const Login=()=>{
   ...
   if(valdite()){
    try{
      const res=await fetch('https://demo-testing-wtql.onrender.com/api/v1/users/login',{
        method:"post",
        headers:{
...
<section class="p-3 p-md-4 p-xl-5">
          <div class="container">
            <div class="card border-light-subtle shadow-sm">
              <div class="row g-0">
                <div class="col-12 col-md-6 bg-primary text-light" style={{backgroundColor:"3E8989"}}>
                  <div class="d-flex align-items-center justify-content-center h-100">
                    <div class="col-10 col-xl-8 py-3">
                      <span className="badge bg-light" style={{color:'black'}}><strong>DOKTORZ</strong></span>
                      {/* <img class="img-fluid rounded mb-4" loading="lazy" src="logoo.jpeg" width="245" height="80" alt="DOKTORZ Logo"/> */}
                    ...
                    <form action="#!">
                      <div class="row gy-3 gy-md-4 overflow-hidden">
                        ...
                        <div class="col-12">
                         ...
                         <div class="col-12">
                          <div class="d-grid">
                            <button class="btn bsb-btn-xl text-light btn-primary" type="submit" onClick={submitHandler}>Sign in</button>
                          </div>
                        </div> 
                      </div>
                    </form>
                      ...
                      <div class="col-12 text-center">
                        ...
                        {/* <div class="d-flex gap-3 flex-column flex-xl-row">
                          ...
                          <a href="#!" class="btn bsb-btn-xl btn-outline-primary">
                            ...
                            <span class="ms-2 fs-6"><LoginFacebook/></span>
                          </a>
